...
const navGroups = [
  {
    label: 'Laporan',
    items: [
      { to: 'projections', label: 'Proyeksi Plan', icon: PieChart },
      { to: 'pnl', label: 'PnL', icon: FileText },
    ],
  },
  {
    ...
    items: [
      ...
      { to: 'investors', label: 'Return Investor', icon: Users },
    ],
  },
  {
    ...
    <div className="flex h-screen bg-background">
      ...
      <aside className="flex w-64 flex-col flex-shrink-0" style={{ background: 'var(--sidebar-bg)' }}>
        ...
        <div className="px-4 pt-3">
          <Link to="/analyst" className="flex items-center gap-2 text-xs text-[#9ca3af] hover:text-white transition-colors">
        ...
        <div className="border-t border-white/10 p-4">
          <div className="mb-3 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-[#6b7280]">Analis</p>
            </div>
          </div>

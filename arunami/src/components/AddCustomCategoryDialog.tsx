...
export function AddCustomCategoryDialog({
  ...
  // Derive effective state: sub mode requires at least one main category;
  // parent id defaults to the first available when unset.
  const mode: Mode = requestedMode === 'sub' && hasMainCategories ? 'sub' : 'main'
  ...
  return (
    ...
    >
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Tambah Baru</DialogTitle>
        </DialogHeader>
